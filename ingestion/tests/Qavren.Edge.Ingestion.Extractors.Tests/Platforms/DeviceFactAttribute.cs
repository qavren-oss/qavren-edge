...
/// that is not Android, iOS or Mac Catalyst. The same shape as SP2's attribute of the same name;
/// it is re-declared here because <c>Qavren.Edge.Onnx.Tests</c> is not, and must not become, a
...
public sealed class DeviceFactAttribute : FactAttribute
{
    ...
    /// about which assembly the runtime actually loaded rather than about silicon.
    /// </summary>
