...
/// because <c>System.IO.Packaging</c> needs a seekable stream and would otherwise copy
/// the whole package into memory, which is exactly the allocation the threshold exists to bound.
/// </summary>
...
/// block's text BEFORE its offsets are computed. Same rules as the core's internal
