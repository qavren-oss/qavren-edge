...
internal static class ProviderRenderer
{
    ...
    internal static string Render(string template, JsonObject manifest)
    {
        ...
        return "// <auto-generated>" + Environment.NewLine +
               ...
               "#pragma warning disable CS1591 // Vendored upstream provider: the public type implements ISQLite3Provider's internal P/Invoke surface, which SQLitePCL.raw already documents upstream." + Environment.NewLine +
